...
// source: phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon
...
class Container_42b439f233 extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/var/www/vendor/larastan/larastan/extension.neon',
			],
			null,
			[
				...
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute85.php',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
				'/var/www/vendor/larastan/larastan/bootstrap.php',
			],
			null,
			'5',
			$this->getService('015'),
	...
	public function createService0126(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/var/www',
			'/var/www/storage/phpstan',
			['phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon', '/var/www/phpstan.neon'],
			$this->getParameter('analysedPaths'),
			['/var/www'],
			$this->getParameter('analysedPathsFromConfig'),
			'5',
	...
	public function createService0145(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			$this->getService('041'),
			[
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/Memcached.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/Redis.stub',
				...
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/file.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/stream_socket_client.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/stream_socket_server.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ctype.stub',
			],
			['/var/www']
		);
	}
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/var/www/storage/phpstan/resultCache.php');
	}
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_42b439f233 $container)
			{
		...
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/var/www/storage/phpstan/resultCache.php',
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/var/www', $this->getService('06'), false);
	}
	...
	{
		return new PHPStan\Dependency\PackageDependencyResolver(['/var/www'], $this->getService('041'));
	}
	...
	{
		return new Larastan\Larastan\Properties\MigrationCache('/var/www/storage/phpstan', false);
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/var/www/storage/phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_42b439f233
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'resultCachePath' => '/var/www/storage/phpstan/resultCache.php',
			...
			'tmpDir' => '/var/www/storage/phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/var/www/storage/phpstan',
			...
			'env' => [
				...
				'APP_ENV' => 'local',
				'APP_KEY' => 'base64:BComIGPFQGIBf93uyYgCrMzjn0VNDlMMmXyxZST7v2Y=',
				'DB_PASSWORD' => 'secret',
