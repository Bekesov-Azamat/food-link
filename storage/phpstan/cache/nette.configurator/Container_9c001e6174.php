...
class Container_9c001e6174 extends _PHPStan_48ec32058\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_9c001e6174 $container)
			{
	...
	public function createServiceContainer(): Container_9c001e6174
	{
		return $this;
	}
